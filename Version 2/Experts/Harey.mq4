#property description "RSI & Stochastic based EA. Different pairs have different optimizaition parameters. \n"
...
#property description "Last modified: 26/November/2020"
...
/* 
      ...
      HAREY ENTRY RULES:
      1. Buy when price go into the oversold level on both RSI & Stochastic.
      2. Sell when price go into the overbought level on both RSI & Stochastic.
...
#define RSI_BUY 3
#define RSI_SELL 4
#define STOCHASTIC_BUY 5
#define STOCHASTIC_SELL 6
...
extern  int Stoc_Overbought = 80;
int stoc_mid = 50;
extern int Stoc_Oversold = 20;
double k0, d0, k1, d1;
...
int start(){
   ...
   /******* Stochastic Setup *******/
   k0 = iStochastic(_Symbol, _Period, kPeriod, dPeriod, slowing, ma_method, 0, MODE_MAIN, 0);
   d0 = iStochastic(_Symbol, _Period, kPeriod, dPeriod, slowing, ma_method, 0, MODE_SIGNAL, 0);
   k1 = iStochastic(_Symbol, _Period, kPeriod, dPeriod, slowing, ma_method, 0, MODE_MAIN, 1);
   d1 = iStochastic(_Symbol, _Period, kPeriod, dPeriod, slowing, ma_method, 0, MODE_SIGNAL, 1);
